...
void SampleApp_ControlCar(void)
{
      if( SampleAppState == 0  )
      {
        ...
        else if( SampleAppDirection == 2 )
        {
          hal_car_turnright();
          osal_start_timerEx( SampleApp_TaskID, SAMPLEAPP_CAR_EVT, 5 );
        }
        else if( SampleAppDirection == 0 )
        {
          hal_car_go();
          osal_start_timerEx( SampleApp_TaskID, SAMPLEAPP_CAR_EVT, 5 );
        }
        else if( SampleAppDirection == 3 )
        {
          hal_car_stop();
        }
        SampleAppState = 1;
      ...
      else if( SampleAppState == 1 )
      {
        hal_car_stop();
        SampleAppState = 0;
        osal_start_timerEx( SampleApp_TaskID, SAMPLEAPP_CAR_EVT, 40 );
      }
}
...
static void SerialApp_CallBack( uint8 port, uint8 event )
{
     ...
     SampleApp_SendPeriodicMessage( Uartbuf, 2 );
}
